                ...
                <div class="col-10 mt-5 ps-5 pt-3 container">
                    ...
                    <div class="row col-12">
                        <table class="table table-bordered">
                            ...
                            <?php
                                $data = mysqli_query($conn, "SELECT * FROM tech WHERE categoria = 'Monitores'");
                                    $i = 0;
            ...
            <div class="modal modal-lg fade" id="registro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body container">
                        <form  class="row" method="post" action="monitores.php">
                            <div class="col-6">
                                <div class="mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea class="form-control" name="comentarios" maxlength="250" id="message-text" rows="8"></textarea>
                            </div>
                        </div>
...
<script>
    document.getElementById("m-dash").classList.add("active");
</script>
...
<script src="../js/main.js" crossorigin="anonymous"></script>
    ...
    include "mysql.php";
        if(isset($_POST['save-pc'])){
            ...
            mysqli_query($conn, "INSERT INTO tech(`categoria`, `nombre`, `tipo`, `marca`, `modelo`, `cantidad`, `estado`, `fecha`, `comentarios`) VALUES('Monitores', '$nombre', '$tipo', '$marca', '$modelo', '$cantidad', '$estado', '$fecha', '$comentarios')");

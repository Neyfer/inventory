                ...
                <div class="col-10 mt-5 ps-5 pt-3 container">
                    ...
                    <div class="row col-12">
                        <table class="table table-bordered">
                            ...
                            <?php
                                $data = mysqli_query($conn, "SELECT * FROM tech WHERE `categoria` = 'Computadoras'");
                                    $i = 0;
...
<script src="../js/main.js" crossorigin="anonymous"></script>
    ...
    include "mysql.php";
        if(isset($_POST['save-pc'])){
            ...
            mysqli_query($conn, "INSERT INTO tech(`categoria`, `nombre`, `tipo`, `marca`, `modelo`, `cantidad`, `estado`, `fecha`, `comentarios`) VALUES('compus', '$nombre', '$tipo', '$marca', '$modelo', '$cantidad', '$estado', '$fecha', '$comentarios')");

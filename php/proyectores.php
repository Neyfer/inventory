        ...
        <div class="col-2">
            ...
            ?>
                ...
                <div class="col-10 mt-5 ps-5 pt-3 container">
                    <div class="row mb-3">
                        <label for="colFormLabel" class="col-sm-1 pe-0 me-0 col-form-label" style="width: 4%">Estado</label>
                    ...
                    <div class="row col-12">
                        <table class="table table-bordered">
                            ...
                            <?php
                                $data = mysqli_query($conn, "SELECT * FROM tech WHERE categoria = 'Proyectores'");
                                    $i = 0;
                                    ...
                                    echo "
                                        <tr>
                                            ...
                                            <td style='white-space:nowrap;width:10%;text-align:center;'>
                                                ...
                                                <button class='btn btn-sm edit btn-success text-light' id='$row[id]' data-bs-toggle='modal' i data-bs-target='#edit_computer_form'><img src='../app_icos/edit2.svg' width='16'height='16'></button>
         ...
         <!-- MODAL FORMULARIO DE REGISTRO -->
            ...
            <div class="modal modal-lg fade" id="registro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header bg-light">
                        <h5 class="modal-title" id="exampleModalLabel">Registrar Proyector</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body container">
                        <form  class="row" method="post" action="proyectores.php">
                            <div class="col-6">
                                <div class="mb-3">
                                ...
                                <input type="number" name="cantidad" value = "1" class="form-control" id="recipient-name">
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-5">
                                ...
                                <textarea class="form-control" name="comentarios" maxlength="250" id="message-text" rows="5"></textarea>
                            </div>
                        </div>
            ...
            <div class="modal modal-lg fade" id="edit_computer_form" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title" id="exampleModalLabel">Editar Proyector</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body container">
                        <form  class="row" method="post" action="proyectores.php">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-5">
                                <label for="message-text" class="col-form-label">Comentarios:</label>
                                <textarea class="form-control" name="e_comentarios" id="comments" rows="5" maxlength="250";></textarea>
                            </div>
                        </div>
...
<script>
    document.getElementById("pro-dash").classList.add("active");
</script>
...
<script src="../js/main.js" crossorigin="anonymous"></script>
    ...
    include "mysql.php";
        if(isset($_POST['save-pc'])){
            ...
            mysqli_query($conn, "INSERT INTO tech(`categoria`, `nombre`, `marca`, `modelo`, `cantidad`, `estado`, `fecha`, `comentarios`) VALUES('Proyectores', '$nombre', '$marca', '$modelo', '$cantidad', '$estado', '$fecha', '$comentarios')");
        ...
        if(isset($_POST['edit-pc'])){
            ...
            $id = $_POST['id'];
            mysqli_query($conn, "UPDATE tech SET `nombre` = '$nombre', `marca` = '$marca', `modelo` = '$modelo', `cantidad` = '$cantidad', `estado` = '$estado', `fecha` = '$fecha', `comentarios` = '$comentarios' WHERE `id` = $id");
             echo "<meta http-equiv='refresh' content='0'>";
        }
